...
namespace FF1_PRR
{
	partial class FF1PRR
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnRandomize.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.btnRandomize.Name = "btnRandomize";
			this.btnRandomize.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
			...
			this.FF1PRFolder.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.CuteHats.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.CuteHats.Name = "CuteHats";
			this.CuteHats.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
        ...
        "e accessible.");
			...
			this.RandoFlags.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.NewChecksum.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.NewChecksum.Name = "NewChecksum";
			this.NewChecksum.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
			...
			this.RandoSeed.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.NewSeed.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.NewSeed.Name = "NewSeed";
			this.NewSeed.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
			...
			this.VisualFlags.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.BrowseForFolder.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.BrowseForFolder.Name = "BrowseForFolder";
			this.BrowseForFolder.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
        ...
        " (eg, level 1 Flare can still only be learned by Black Wizard)");
			...
			this.flagRebalancePrices.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
        ...
        "ere else.");
			...
			this.flagReduceChaosHP.Padding = new System.Windows.Forms.Padding(3, 3, 3, 3);
